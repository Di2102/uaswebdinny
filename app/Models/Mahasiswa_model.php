...
class Mahasiswa_model extends Model
{
    ...
    public function data_mahasiswa_json(){ 
		...
		a.tgl_lahir,a.jenis_kelamin,b.agama,c.prodi,
		d.provinsi,a.alamat_lengkap, a.tgl_masuk from tab_mahasiswa as a 
		left join tab_agama as b on a.agama = b.id
		left join tab_prodi as c on a.prodi = c.id
		left join tab_provinsi as d on d.provinsi = d.id");
